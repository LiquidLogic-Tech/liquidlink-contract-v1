/// forked from Suilend: [https://github.com/solendprotocol/suilend/blob/07b0db139fc88e0b7365cdb20a0bf07ce4076e0a/contracts/sources/decimal.move]
/// fixed point decimal representation. 18 decimal places are kept.
module liquidlink_protocol::decimal {
    // 1e18
...
#[test_only]
module liquidlink_protocol::decimal_tests {
    use liquidlink_protocol::decimal::{add, sub, mul, div, floor, ceil, pow, lt, gt, le, ge, from, from_percent, saturating_sub};
